...
<script type="text/javascript">
                ...
                <!--
                        function open_info()
                        {
                                window.open('consulterpaiement.html','nom_de_ma_popup','menubar=no, scrollbars=no, top=100, left=100, width=800, height=200');
                        }
                -->
                </script>
...
{
    if(confirm("Voulez vous vraiment supprimer cette demande de crédit ?"))
    {
...
<div class="header"><a href="new 1.html"><img src="dec.png" width="35" height="30"/> <p><font color="#FFF">D&eacuteconnexion </font></p></a></div>
<div class="counter">
